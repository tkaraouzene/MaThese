...
% Everything below added by CII
  ...
  \item
    ...
    important de patients portant des variant sur celui\_ci, notamment 5
    potant des variants tronquants homozygote font de ce gène un bon
    candidat.\\
  \item
    \textbf{\emph{FSIP2}} : L'analyse bibliographique du gène \emph{FSIP2}
    révèle qu'une équipe a démontré en 2003 l'implication de ce gène dans
    la structure de la gaine fibreuse du flagelle spermatique confirmant
    que ce gène est un bon candidat pour expliquer le phénotype MMAF des 2
