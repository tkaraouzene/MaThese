...
% Everything below added by CII
  ...
  Comme expliqué précédemment, La globozoospermie est phénotype menant à
  l'infertilité masculine rare (prévalence \textless{} 0.1\%) mais
  néanmoins sévère (C. G. S. Sen et al.,
  \protect\hyperlink{ref-Sen2009}{1971}). Cette anomalie est caractérisée
  par la présence de spermatozoïdes présentant une tête ronde dépourvue
  d'acrosome et d'une pièce intermédiaire désorganisée dans l'éjaculat
  (Singh, n.d., Pedersen \& Rebbe
  (\protect\hyperlink{ref-Pedersen1974}{1974})) (\textbf{Figure :
  }\ref{fig:globospz}. On distingue la globozoospermie totale avec 100\%
  des spermatozoïdes présentant le phénotype ou partielle en fonction du
  taux de spermatozoïdes atteints. Bien que l'infertilité masculine soit
  souvent la résultantes de plusieurs facteurs, les premières études
  présentants des patients atteints par un phénotype complet (C. G. S. Sen
  et al., \protect\hyperlink{ref-Sen2009}{1971}) suggéraient que la
  globozoospermie était une exception. De plus les caractéristiques
  morphollogiques très typiques des spermatozoïdes laissaient penser à une
  cause monogénique.En 2007, une étude portant sur une famille juive
  ashkenaz comprenant six frères dont trois atteins a pu mettre lier ce
  ...
  mutations de ce gènes n'étaient pas les seules responsables. En 2011,
  une autre étude portant sur une cohorte de 20 patients Tunisiens a pu
  mettre en évidence une délétion homozygote de 200kb emportant la
  totalité du gène \emph{DPY19L2} chez 15 des 20 patients (Harbuz et al.,
  \protect\hyperlink{ref-Harbuz2011}{2011}). Les études effectuées
  ulterieurement sur ce phénotype ont ensuite pu montrer que les
  altération de gène \emph{DPY19L2}, et notamment cette délétion, étaient
  ...
  For example, PLCzeta ,the sperm factor required for oocyte activation,
  is absent or minimally present in globozoospermia (Heytens et al., 2009;
  Taylor et al., 2010; Yoon et al., 2008). This compromises oocyte
  activation and therefore accounts, at least partly, for the low
  fertilization rate observed with these individuals.
  ...
  \caption[Observation au microscope à balayage d'un spermatozoïde normal (**A**) et d'un spermatozoïde globozoocéphale (**B**)]{Observation au microscope à balayage d'un spermatozoïde normal (**A**) et d'un spermatozoïde globozoocéphale (**B**) adapté d'après [@Harbuz2011]}\label{fig:globospz}
  \end{figure}
  
  \section{Le gène DPY19L2}\label{le-gene-dpy19l2}
  ...
  homologie favoriser les duplication de gènes jouant ainsi un rôle
  ...
  (figure phénotype souris) mais aussi et surtout, l'ensembles des autres
  dysfonctionnement étaient retrouvés, c'est à dire : l'absence de
  l'acrosome, les défaults morphologiques du noyau, de l'enveloppe
  nucléaire et de l'acroplaxome ainsi que le mauvais positionnement de la
  manchette (V. Pierre et al., \protect\hyperlink{ref-Pierre2012}{2012}).
  Ainsi il a pu être démontré que la protéine Dpy19l2 étaient
  principalement exprimé dans le spermatides et plus spécifiquement dans
  la membrane nucléaire intèrne faisant face à la vésicule acrosomale et
  que l'absence de cette protéine entrainait la destabilisation à la fois
  de la lamine nucléaire, de la jonction entre l'acroplaxome et
  l'enveloppe nucléaire (V. Pierre et al.,
  \protect\hyperlink{ref-Pierre2012}{2012}).
  
  \section{Résultats}\label{resultats}
  
  \subsection{Les méchanismes mutationnels
  (PLOS)}\label{les-mechanismes-mutationnels-plos}
