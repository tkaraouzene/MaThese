...
% Everything below added by CII
  ...
  L'application de de notre pipeline d'analyse nous a permi d'obtenir une
  liste de \ldots{} variant distincts avec une moyenne de \ldots{} par
  patients (insert fig) sur lesquels nous avons appliqués les filtres
  précédemments décrits. Ainsi, (répéter les filtres utilisés).
  ...
  gènes différents. Au vu du nombre important de gène restant et afin
  d'étudier en priorité ceux pouvant expliquer le phénotype d'un maximum
  de patients nous avons, comme précédemment, limité nos premières
  recherches aux gènes sur lesquels \textbf{au moins 2 patients portaient
  un variant tronquant} réduisant à nouveaux cette liste à \ldots{} gènes
  différents.
  
  À l'issus de ces résultats nous nous somme dans un premiers temps
  concacrés à la caractérisation des gènes \emph{CFAP43} et \emph{CFAP44}
  
  \newpage
  
  \begin{center}\includegraphics{thesis_files/figure-latex/plottwohomohigh-1} \end{center}
  ...
  Patient & Gene & Genotype & HGVSc, HGVSp & Consequence & ExAC & ESP & 1KG\\
  \midrule
  Ghs17 & CFAP43 & Homozygous & c.2658G>A ; p.Trp886Ter & stop gained & 9.88e-05 & 2e-04 & .\\
  Ghs22 & CFAP44 & Homozygous & . ; p.Arg1059Ter & stop gained & . & . & .\\
  Ghs25 & CFAP43 & Homozygous & c.2141+5T>A ; . & splice region & . & . & .\\
  Ghs34 & CFAP44 & Homozygous & . ; . & splice donor & . & . & .\\
  Ghs41 & CFAP43 & Homozygous & c.2680C>T ; p.Arg894Ter & stop gained & 8.24e-06 & . & .\\
  \addlinespace
  Ghs89 & CFAP44 & Homozygous & c.1457A>T ; p.Ala486Val & missense & 0.000692 & 0.0012 & 0.0014\\
  Ghs102 & CFAP43 & Homozygous & c.3882delA ; p.Glu1294AspfsTer47 & frameshift & . & . & .\\
  Ghs105 & CFAP43 & Homozygous & c.3541-2A>C ; . & splice acceptor & . & . & .\\
  Ghs126 & CFAP43 & Homozygous & c.3352C>T ; p.Arg1118Ter & stop gained & 3.29e-05 & . & .\\
  Ghs132 & CFAP43 & Heterozygous & c.1300\_1301insT ; p.Leu435SerfsTer26 & frameshift & . & . & .\\
  Ghs132 & CFAP43 & Heterozygous & c.1040G>C ; p.Val347Ala & missense & 7.41e-05 & 2e-04 & .\\
  \bottomrule
  \end{longtable}
  \end{landscape}
