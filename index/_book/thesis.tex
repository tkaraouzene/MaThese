...
% Everything below added by CII
  ...
  MMAF & MYH11 & c.4625G>A ; p.Arg1542Gln & missense & . & proba damaging & 0.00234 & 0.0016 & 5e-04\\
  MMAF & DNAH1 & . ; . & splice acceptor & . & . & . & . & .\\
  \bottomrule
  \end{longtable}
  \end{landscape}
  ...
  L'oligospermie, comme l'azoospermie sont des infertilités masculines
  liées à la quantité de spermatozoïdes présent dans l'éjaculât. Les
  différentes études publiées ces dernières années montrent que les
  microdélétions du chromosome Y sont retrouvées chez 10\% des hommes avec
  une azoospermie non-obstructives et chez 5\% des patients avec une
  oligozoospermie sévères (Hotaling \& Carrell,
  ...
  (homozygous) and their parents (heterozygous)
  
  . PINK2 whole coding sequences of 611 patients affected by azoo- or
  oligozoospermia (210 patients with azoospermia, 393 subjects with
  oligozoospermia and 8 with unspecified cause Only one variant,
  identified in patient 105 (P105), was not described in ExAC and was
  likely deleterious (insert Table). This variant, c.1A\textgreater{}T
  (Fig EV1A), abrogates the SPINK2 start codon and was present
  heterozygously in P105, a man with oligozoospermia. An alternate start
  site could potentially be used in the middle of exon 3 allowing the
  synthesis of a truncated protein of 2 kDa lacking the reactive site and
  disulfide bonds, both known to be crucial for SPINK2 function
  
  . In order to confirm that the absence of SPINK2 leads to azoospermia,
  homozygous Spink2 KO ( / ) mice were obtained and their reproductive
  phenotype was studied . were completely infertile, whereas no
  reproductive defects were observed in females
  
  Moreover, despite normal fertility, heterozygous male mice had a high
  rate of morphologically abnormal spermatozoa and a reduced sperm
  motility
  ...
  \subsubsection{Discussion et
  Perspectives}\label{discussion-et-perspectives-3}
