...
% Everything below added by CII
  ...
  {\centering \includegraphics[scale=.28]{figure/sequeneur_a_travers_le_temps} 
  
  }
  
  \caption[Appercu non exostif des instruments de séquençage haut-débit présentés entre 2004 et 2015]{Appercu non exostif des instruments de séquençage haut-débit présentés entre 2004 et 2015 d'après [@Meienberg2016] : Présentation des différentes plateformes de séquençage haut débit commercialisés dans la dernière décénie. SBS : séquençage par synthèse ; SMS : séquençage de molécule unique ; SBL : séquençage par ligation}\label{fig:seqtime}
  \end{figure}
  
  Il existe trois technologies principales permettant le séquençage de
  \emph{reads} courts, ces différentes techniques on vu leur apparition à
  travers le temps et chaque plateforme \ldots{}.. (\textbf{Figure :
  }\ref{fig:seqtime}) :
  ...
  \item
    ...
    \item
      ...
      parlera de groupement \(\mathrm{3'-blocqué}\). Le processus est
      ...
      \(\mathrm{3'-blocqué}\) sont mis en contact du fragment. Après
      ...
      fluorophore. Le fluorophore et le groupement \(\mathrm{3'-blocqué}\)
  ...
  \caption[Exemple de séquençage SNA tel qu'il est effectué par Ion Torrent]{Exemple de séquençage SNA tel qu'il est effectué par Ion Torrent d'après [@Goodwin2016] : }\label{fig:snaSeq}
  \end{figure}
  ...
  \item
    ...
    fluorophore. Cette sonde s'hybridise au brin d'ADN
  \item
    \textbf{Séquençage par SMS} (SMS) :
  \end{enumerate}
