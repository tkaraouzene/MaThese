...
% Everything below added by CII
  ...
  desorganisations au niveau moléculaire. Par exemble, le facteur
  ...
  (\protect\hyperlink{ref-Yoon2008}{2008})) compremettant ainsi
  l'activation ovocytaire et expliquant les faible taux de fécondation
  ...
  Bien que l'infertilité masculine soit souvent la résultantes de
  plusieurs facteurs, les premières études présentants des patients
  atteints par un phénotype complet (C. G. S. Sen et al.,
  ...
  ashkenaz comprenant six frères dont trois atteins a pu lier ce phénotype
  à une mutation homozygotes sur le gène \emph{SPATA16} présente chez les
  trois frères atteint (A. H. D. M. Dam et al.,
  ...
  totalité du gène \emph{DPY19L2} chez 15 des 20 patients analysés (Harbuz
  et al., \protect\hyperlink{ref-Harbuz2011}{2011}). Les études effectuées
  ...
  l'ensembles des autres dysfonctionnement étaient retrouvés, c'est à dire
  : l'absence de l'acrosome, les défaults morphologiques du noyau, de
  ...
  spermatides et plus spécifiquement dans la membrane nucléaire intèrne
  faisant face à la vésicule acrosomale et que l'absence de cette protéine
  entrainait la destabilisation à la fois de la lamine nucléaire, de la
  ...
  Comme vu précédemment, l'emmergence du séquençage haut débit avec
  nottament les séquençage de génomes ou d'exomes entiers a révolutionné
  les méthodes de recherche dans le cadre d'étude
  phénotype-génotype\ldots{}
  ...
  des tris successif efficaces et pertinents
  
  \section{Resultats}\label{resultats-1}
  ...
  \tightlist
  \item
    Les nouveaux gènes candidats évidents\\
  \item
  ...
  \item
    ...
    \tightlist
    \item
      Les mutations dans les gènes identifiés\\
    \item
      Liste complète des gènes avec 2 variants tronquants\\
      c Liste complète des gènes avec deux variants dont un tronquant\\
    \item
      Liste des gènes avec 2 variants intronique ou faux-sens/synonymes
      avec un score élevé UMD-predictor ou HSF.\\
    \item
      Liste des gènes avec un variant hétérozygote tronquant
    \end{enumerate}
  \end{enumerate}
