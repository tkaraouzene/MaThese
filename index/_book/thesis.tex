...
% Everything below added by CII
  ...
  \caption[Les différentes étapes de la méiose gamétique masculine]{Les différentes étapes de la méiose gamétique masculine d'après D’après Sasaki et Matsui, 2008}\label{fig:meiose}
  \end{figure}
  ...
  \tightlist
  \item
    \textbf{Méiose réductionelle} : (\textbf{Figure : }\ref{fig:meiosei})
  ...
  \tightlist
  \item
    \textbf{Méiose équationelle} : (\textbf{Figure : }\ref{fig:meioseii})
  ...
  \item
    ...
    \item
      ...
      \tightlist
      \item
        La translocation est définie comme l'échange de materiel génétique
        ...
        générale (Elliott \& Cooke, 1997), les secondes sont retrouvées
        chez 1.6\% des patients oligozoospermiques et 0.09\% des patients
        azoospermiques (O'Flynn O'Brien, Varghese, \& Agarwal, 2010).\\
      \item
        Les inversions chromosomiques caractérisent le mécanisme de cassur
        ...
        retrouvées plus fréquemment chez les patients infertiles que dans
        la population générale (Krausz \& Forti, 2000).\\
      \end{enumerate}
    \item
      \textbf{Autres anomalies chromosomiques} : Parmis les anomalies de
      structures chromosomique responsables d'infertilité masculine, on
      peut par exemple citer les hommes de formule 46,XX bien quelle soit
      ...
      azoospermie par absence des sous- régions AZFa,b et c (Vorona,
      Zitzmann, Gromoll, Schüring, \& Nieschlag, 2007) bien qu'ils aient
      un phénotype masculin normal.
    \end{enumerate}
  \item
    \textbf{Mutations du gène \emph{CFTR} }: L'identification du gène
    \emph{CFTR} (Cystic Fibrosis Transmembrane conductance Regulator) chez
    les patients atteints de mucovisidose et présentant une agénésie
    bilatérale des canaux déférents (ABCD) a permis d'associer ce gène au
    phénotype d'azoospermie obstructive. Cette malformation serait
    responsable de 2\% des cas d'infertilité masculine et de 25\% des cas
    d'azoospermie obstructive (J. Yu, Chen, Ni, \& Li, 2012).
  \end{enumerate}
