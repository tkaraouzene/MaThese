...
1. **Les appels *double strand* (DS)** :  ils qualifient les positions ayant une couverture $\ge$ 10 sur **les deux** *strands*. Ces appels sont ceux ayant la meilleure qualité.  
...
```{r plotcovplcz, fig.cap='(ref:plotcovplcz)',fig.scap=fig.cap='(ref:plotcovplcztitle)', ,out.extra="scale=.37", cache=TRUE}

fig_name <- "Couverture des 6 exons de *WBP2NL* pour les deux frères de la famille FF"
