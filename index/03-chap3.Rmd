...
df_remaining_gene <- rbind(df_filter_az %>% distinct(SYMBOL,FAM.x),
           df_filter_ff %>% distinct(SYMBOL,FAM.x),
           df_filter_mmaf1 %>% distinct(SYMBOL,FAM.x),
           df_filter_mmaf2 %>% distinct(SYMBOL,FAM.x),
           df_filter_mmaf3 %>% distinct(SYMBOL,FAM.x),
           df_filter_mmaf4 %>% distinct(SYMBOL,FAM.x)) %>%
  group_by(FAM.x) %>%
  summarise(N = n())
