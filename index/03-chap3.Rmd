...
<!--  TODO : Indiquer la stratégie d'analyse (variats homozygote, pourquoi .... -->

Un récapitulatif des familles et de leur phénotype est disponible dans la table \@ref(tab:tabrecapfam).    

```{r tabrecapfam}

# TODO ajouter la consanguinité familiale dans le tableau
# ajouter les identifiant des patients utilisés après
...
gene_mmaf1 <- df_remaining_gene %>% filter(Familly == "MMAF1")
...
```{r tablegene}
# todo refaire la table avec une ligne pare famille et description des mutations pour chaque gènes restant
