...
Ce mécanisme de NAHR devrait, en théorie, engendrer la formation de plus d'allèles délétés que d'allèles dupliqués puisque seuls les remaniments interchromatidiens les induisent la formation d'un allèle dupliqué tandis que les délétions surviennent à la fois lors des remanimets interchromatidiens **et** intrachromatidiens [@Liu2012] (**Figure : **\@ref(fig:pictnahr)). Cependant, les données mises à disposition par la base de données [*Database of Genomic Variants*](http://dgv.tcag.ca/dgv/app/home) (DGV) [@MacDonald2014] indiquent un excès de duplication puisque sur un total de 6575 individus analysés, 83 duplications et de 26 délétions hétérozygotes ont été observées pour le locus de *DPY19L2*.  
