...
```{r plotexpfamaz, fig.cap='(ref:plotexpfamaz)',fig.scap=fig_name, dependson="varrecapaz", cache=TRUE}
...
```{r plotexpfamff, fig.cap='(ref:plotexpfamff)',fig.scap=fig_name, fig.asp=.65, cache=TRUE}
...
```{r plotcovplcz, fig.cap='(ref:plotcovplcz)',fig.scap=fig_name, ,out.extra="scale=.4", cache=TRUE}
