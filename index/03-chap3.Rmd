...
```{r picvarcall,fig.cap=fig_info,fig.scap=fig_name, out.extra="scale=0.5"}
...
```{r picdensityvar,fig.cap=fig_info,fig.scap=fig_name}

# fig_name <- "Densité de répartition du pourcentage de *reads* variant en fonction de différentes valeurs de couverture minimale"
# 
# fig_description <- ""
# 
# fig_info <- paste0(fig_name," : ",fig_description)
# 
# include_graphics(path = "figure/var_percent_density.png")

```

```{r plotdensityvar,fig.cap=fig_info,fig.scap=fig_name}
...
density_plot_file <- "figure/density_plot.jpg"
...
fread("zcat ~/countsForHisto_PR_all.csv.gz", sep = ",", header = TRUE, showProgress = FALSE, data.table = FALSE, verbose = FALSE) %>%
  ...
  ggsave(density_plot_file, dpi = 800)
...
```{r plotfilternonpertinanttr, fig.cap=fig_info,fig.scap=fig_name,fig.width=6.3, fig.height=3.2, cache=TRUE}
...
```{r plotremaininggenes, fig.height=7, fig.cap=fig_info,fig.scap=fig_name, cache=TRUE}
