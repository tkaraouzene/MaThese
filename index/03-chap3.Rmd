...
kable(df_recap %>% select(-CANONICAL, -HGVSc, -HGVSp),
      format = "latex",
      booktabs = TRUE,
      longtable = TRUE,
...
L'oligospermie, comme l'azoospermie sont des phénotypes d'infertilités masculines liées à la quantité de spermatozoïdes présent dans l'éjaculât. Les différentes études publiées ces dernières années montrent que les microdélétions du chromosome Y sont retrouvées chez 10% des hommes avec une azoospermie non-obstructives et chez 5% des patients avec une
...
```{r plotexpfamaz, fig.cap=fig_info,fig.scap=fig_name, cache=TRUE}
